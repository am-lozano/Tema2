...
public class Ej2 {
	...
	public static void main(String[] args) {
		...
		while (numero > 0) {
			...
			// sumamos 1 a la variable contador cada vez que el numero entre en el bucle
			// para contarlo
			contador++;
		...
		System.out.println("Como se ha introducido un numero negativo el programa finaliza, ha introducido un total de "
				+ contador + " numeros");
